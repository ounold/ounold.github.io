...
131. Dawid Kondziela (2021) projekt inżynierski
Projekt i implementacja rozmytego klasyfikującego systemu antycypacyjnego

130. Mateusz Chmielewski (2021)
Analiza porównawcza wybranych mechanizmów działania antycypacyjnych systemów klasyfikujacych

129. Mateusz Gabor (2020)
Zmodyfikowany algorytm split-merge w indukcji bezkontekstowej gramatyki stochastycznej

128. Mateusz Wiśniewski (2020)
Zmodyfikowany algorytm kompresji w indukcji gramatyki bezkontekstowej

127. Mariusz Kwidzyński (2020) projekt inżynierski
Wizualizacja działania klasyfikatorów systemu ACS2

126. Monika Rzepecka (2019)
Algorytmy parsowania gramatyk probabilistycznych

125. Arkadiusz Cyktor (2019)
Biblioteka jGCS w Javie. Implementacja i analiza wybranych mechanizmów indukcji.

124. Jakub Dymon (2019)
Zastosowanie algorytmu Contrastive Estimation w indukcji bezkontekstowej gramatyki stochastycznej

123. Sebastian Korniewicz (2019) projekt inżynierski
Projekt i implementacja biblioteki programistycznej do oceny algorytmów rozwiązujących problem plecakowy

122. Kacper Tokarczuk (2019) projekt inżynierski
Rozszerzenie funkcjonalności biblioteki pyGCS o nowy algorytm odkrywczy

121. Mateusz Gabor (2019) projekt inżynierski
Rozszerzenie funkcjonalności biblioteki pyGCS o mechanizm Contrastive Estimation z funkcją kosztu

120. Michał Szymański (2019) projekt inżynierski
Rozszerzenie funkcjonalności biblioteki pyALCS o mechanizm PEE

119. Edyta Rogula (2019) projekt inżynierski
Rozszerzenie funkcjonalności biblioteki pyALCS o mechanizm planowania akcji

118. Mateusz Fislak (2018)
Biblioteka xGCS w Pythonie. Implementacja i analiza wybranych mechanizmów indukcji.

117. Michał Czarnecki (2018)
Biblioteka xGCS w Pythonie. Implementacja i analiza równoległego algorytmu CYK.

116. Grzegorz Rorbach (2018)
Biblioteka xGCS w Pythonie. Implementacja i analiza wybranych metod estymacji prawdopodobieństw reguł.

115. Daniel Cieszko (2018)
Biblioteka xGCS w Pythonie. Wizualizacja wyników indukcji.

114. Bartosz Jabłonka (2018)
Zastosowanie uczenia maszynowego w predykcji defektów programistycznych typu "re-open"

113. Paweł Dudzic (2017)
Zastosowanie technologii big data i metod sztucznej inteligencji w analizie danych bioinformatycznych
...
Zespołowy uczący sie system klasyfikujący w zadaniach eksploracji danych
...
### Wykład
[Slajdy z wykładu (wersja z dnia 18.01.2017, pdf, zip, 3.5MB)](files/wyklad%20kierowanie%20projektem%20programistycznym.zip)\
[Slajdy z wykładu prowadzonego przez pracownika Capgemini (10.03.2010, pdf, zip, 1MB)](files/capgemini.zip)

### Seminarium
[Przykładowe tematy seminaryjne (pdf, 80kB)](files/Przykladowe%20tematy%20na%20seminarium%20z%20KPP.pdf)

#### Pomocne dokumenty:
[Slajdy z seminarium Sztuka prezentacja autor S. Jędrysiak (pdf, zip, 800kB)](files/seminarium%20sztuka%20prezentacji.zip)\
[27 błędów (pdf, 525kB)](files/27%20bledow.pdf)

## Seminarium dyplomowe inżynierskie i magisterskie
[Zawartość prezentacji (pdf, 14kB)](files/Zawartosc%20prezentacji%20dyplomowej.pdf)
...
### Wykład
[Slajdy z wykładu J.Magott 1 (wersja z dnia 9.03.2021, pdf, zip, 1.2MB)](files/J.Magott%20W1.zip)\
[Slajdy z wykładu J.Magott 2 (wersja z dnia 26.02.2018, pdf, zip, 0.8MB)](files/J.Magott%20W2.zip)\
[Slajdy z wykładu J.Magott 3 (wersja z dnia 20.03.2021 pdf, zip, 1.3MB)](files/J.Magott%20W3.zip)\
